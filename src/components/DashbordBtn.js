  ...
  return (
    <Dropdown>
      ...
      <Menu slots={{ listbox: StyledListbox }}>
        <Link className="links2" to="/setting">
          {logged && <StyledMenuItem>Setting</StyledMenuItem>}
        </Link>
        <StyledMenuItem onClick={createHandleMenuClick("Language settings")}>Language settings</StyledMenuItem>
        {logged && (
          <StyledMenuItem>
            <button className="button-Logout-danger" type="submit" onClick={logMeOut}>
              Logout
            </button>
          </StyledMenuItem>
        )}
